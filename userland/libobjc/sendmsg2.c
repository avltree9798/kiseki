...
// __thread replaced with static — Kiseki dyld has no TLS support yet.
// This is safe as long as we are single-threaded (or accept the race).
static struct objc_method uncacheable_slot = { (IMP)nil_method, NULL, NULL };
static struct objc_slot uncacheable_slot_v1 = { Nil, Nil, 0, 0, (IMP)nil_method };
